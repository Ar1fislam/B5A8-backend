...
export const adminController = {
  ...
  async getAllUsers(req: AuthRequest, res: Response) {
    ...
    const filters: Filters = {
      search: restQuery.search || undefined,
      role:
        restQuery.role === 'ADMIN'
          ? 'ADMIN'
          : restQuery === 'USER'
          ? 'USER'
          : undefined,
      isActive:
        restQuery.isActive !== undefined
          ? Boolean(restQuery.isActive)
          : undefined,
      isPremium:
        restQuery.isPremium !== undefined
          ? Boolean(restQuery.isPremium)
          : undefined,
    }
